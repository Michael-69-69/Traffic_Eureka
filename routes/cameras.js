...
const cameras = {
    'ly-thai-to-nguyen-dinh-chieu': {
        ...
        originalUrl: 'https://giaothong.hochiminhcity.gov.vn/expandcameraplayer/?camId=63ae763bbfd3d90017e8f0c4&camLocation=L%C3%BD%20Th%C3%A1i%20T%E1%BB%95%20-%20Nguy%E1%BB%85n%20%C4%90%C3%ACnh%20Chi%E1%BB%83u&camMode=camera&videoUrl=https://d2zihajmogu5jn.cloudfront.net/bipbop-advanced/bipbop_16x9_variant.m3u8',
        status: 'active',
        data: {
            density: '45%',
            weather: 'Sunny',
    ...
    'ba-thang-hai-su-van-hanh': {
        ...
        lng: 106.6638,
        videoUrl: 'https://d2zihajmogu5jn.cloudfront.net/bipbop-advanced/bipbop_16x9_variant.m3u8',
        originalUrl: 'https://giaothong.hochiminhcity.gov.vn/expandcameraplayer/?camId=63ae7a50bfd3d90017e8f2b2&camLocation=Ba%20Th%C3%A1ng%20Hai%20%E2%80%93%20S%C6%B0%20V%E1%BA%A1n%20H%E1%BA%A1nh&camMode=camera&videoUrl=https://d2zihajmogu5jn.cloudfront.net/bipbop-advanced/bipbop_16x9_variant.m3u8',
        status: 'active',
        data: {
            density: '60%',
            weather: 'Cloudy',
    ...
    'nga-sau-cong-hoa': {
        ...
        lng: 106.6527,
        videoUrl: 'https://d2zihajmogu5jn.cloudfront.net/bipbop-advanced/bipbop_16x9_variant.m3u8',
        originalUrl: 'https://giaothong.hochiminhcity.gov.vn/expandcameraplayer/?camId=5deb576d1dc17d7c5515acf6&camLocation=N%C3%BAt%20giao%20Ng%C3%A3%20s%C3%A1u%20C%E1%BB%99ng%20H%C3%B2a&camMode=camera&videoUrl=https://d2zihajmogu5jn.cloudfront.net/bipbop-advanced/bipbop_16x9_variant.m3u8',
        status: 'active',
        data: {
            density: '75%',
            weather: 'Rainy',
    ...
    'ly-thai-to-su-van-hanh': {
        ...
        lng: 106.6823,
        videoUrl: 'https://d2zihajmogu5jn.cloudfront.net/bipbop-advanced/bipbop_16x9_variant.m3u8',
        originalUrl: 'https://giaothong.hochiminhcity.gov.vn/expandcameraplayer/?camId=6623e7076f998a001b2523ea&camLocation=L%C3%BD%20Th%C3%A1i%20T%E1%BB%95%20-%20S%C6%B0%20V%E1%BA%A1n%20H%E1%BA%A1nh&camMode=camera&videoUrl=https://d2zihajmogu5jn.cloudfront.net/bipbop-advanced/bipbop_16x9_variant.m3u8',
        status: 'active',
        data: {
            density: '35%',
            weather: 'Sunny',
...
router.get('/', (req, res) => {
    res.json({
        success: true,
        cameras: cameras,
        count: Object.keys(cameras).length
    });
});
...
// Get camera feed URL
router.get('/:cameraId/feed', (req, res) => {
    const { cameraId } = req.params;
    const camera = cameras[cameraId];
...
// Get camera data/analytics
router.get('/:cameraId/data', (req, res) => {
    const { cameraId } = req.params;
    const camera = cameras[cameraId];
...
router.post('/', (req, res) => {
    const { camera } = req.body;
    const selectedCamera = cameras[camera];
